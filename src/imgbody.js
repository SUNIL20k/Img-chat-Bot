    ...
    <div className="right-side">
      <div className="chitti-right">
        ...
        <div className="chat-box">
          <h1 className="display-4 fw-bold intro">
            Hello, I'm Smart pixel
          </h1>
          ...
          {searches.map((search, index) => (
            <div className="message" key={index}>
              <div className="rev-box">
                ...
                <div>
                <h3 style={{ marginTop: "0px", marginLeft: "25px", marginBottom: "20px", fontSize: "30px", color: "white" }}>user</h3>
              ...
              <div style={{ marginLeft: "20px" }}>
                <h3 className="text-white mb-3">pixel <sup className="fs-6 mb-5"> [Ai]</sup></h3>
